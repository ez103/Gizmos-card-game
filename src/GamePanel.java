...
public class GamePanel extends JPanel{
    private BufferedImage ep7,ep8,ep9,epy,epr,epblue,epblack,chest,purp,green,org,blank,arc,res,back;
    public GamePanel()
    {
        try{
            ep7 = ImageIO.read(GamePanel.class.getResource("/cardImages/tool1.png"));
            ep8 = ImageIO.read(GamePanel.class.getResource("/cardImages/tool2.png"));
            ep9 =ImageIO.read(GamePanel.class.getResource("/cardImages/energ.png"));
            epy =ImageIO.read(GamePanel.class.getResource("/cardImages/ylw.png"));
            epr =ImageIO.read(GamePanel.class.getResource("/cardImages/red.png"));
            epblue =ImageIO.read(GamePanel.class.getResource("/cardImages/blue.jpg"));
            epblack =ImageIO.read(GamePanel.class.getResource("/cardImages/black.png"));
            chest =ImageIO.read(GamePanel.class.getResource("/cardImages/chest.jpg"));
            purp     =ImageIO.read(GamePanel.class.getResource("/cardImages/purp.png"));
            green     =ImageIO.read(GamePanel.class.getResource("/cardImages/lvl2.png"));
            org     =ImageIO.read(GamePanel.class.getResource("/cardImages/org.png"));
            blank     =ImageIO.read(GamePanel.class.getResource("/cardImages/blank.png"));
            arc     =ImageIO.read(GamePanel.class.getResource("/cardImages/blank.png"));
            res     =ImageIO.read(GamePanel.class.getResource("/cardImages/res.png"));
            back     =ImageIO.read(GamePanel.class.getResource("/cardImages/back.jpg"));
